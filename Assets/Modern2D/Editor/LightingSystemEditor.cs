...
namespace Modern2D
{
    ...
    public class LightingSystemEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            LightingSystem.defaultShadowSprflipx = GUILayout.Toggle(LightingSystem.defaultShadowSprflipx, "default shadow sprite flip-x");
            LightingSystem.shadowSprFlip = GUILayout.Toggle(LightingSystem.shadowSprFlip, "flips shadow sprite horizontaly based on orientation");
